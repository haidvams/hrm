...
import 'package:hrm/smartDeck/ModelClass/ScoreboardAvailableModel.dart';
...
class T1EmployeeAttendance extends StatefulWidget {
  @override
...
class _SDExamCompletionBoardScreenState
    extends State<T1EmployeeAttendance>
                        ...
                        Padding(
                          ...
                          child: Center(
                            child: Text(
                              ...
                              maxLines: 2,
                              style: TextStyle(
                                  fontFamily: fontBold, fontSize: 22, color: Colors.white),
                            ),
                          ),
                        ),
                        Align(
